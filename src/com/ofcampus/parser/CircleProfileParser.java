...
//			mDialog.show();
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				String[] responsedata = Util.POST_JOB(Util.getCircleProfileUrl(), postData, authorization);
...
//	{"circleId":22,"pageNo":0, "perPage":8, "appName":"ofCampus", "plateFormId":0}
	...
	public void setCircleprofileparserinterface(
			CircleProfileParserInterface circleprofileparserinterface) {
