...
public class RejectRequestToJoinCircleParser {
	...
	private class RejectRequestParserAsync extends AsyncTask<Void, Void, Void> {
		...
		public RejectRequestParserAsync(Context mContext,
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				String[] responsedata = Util.POST_JOB(Util.getRejectRequestUrl(), postData, authorization);
...
//	{"circleId":21, "userId": 5,"appName":"ofCampus", "plateFormId":0}	
	...
	public void setRejectRequestparserinterface(
			RejectRequestParserInterface RejectRequestparserinterface) {
