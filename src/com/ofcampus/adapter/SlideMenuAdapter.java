...
//            itemView.setOnClickListener(this);
    ...
    public SlideMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_item_row,parent,false); //Inflating the layout
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.slidemenu_pfpic_header,parent,false); //Inflating the layout
