	...
	public static void loadGalleryPhotosAlbums(Context mContext , final int guid) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Cursor cursor = null;
                try {
                    cursor = MediaStore.Images.Media.query(OfCampusApplication.applicationContext.getContentResolver(), MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projectionPhotos, "", null, MediaStore.Images.Media.DATE_TAKEN + " DESC");
                    if (cursor != null) {
