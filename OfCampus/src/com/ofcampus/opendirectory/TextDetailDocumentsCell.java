...
package com.ofcampus.opendirectory;
...
public class TextDetailDocumentsCell extends FrameLayout {
	...
	public TextDetailDocumentsCell(Context context) {
		...
		layoutParams.topMargin = OfCampusApplication.dp(10);
		layoutParams.leftMargin = OfCampusApplication.dp(71);
		layoutParams.rightMargin = OfCampusApplication.dp(16);
		...
		layoutParams.width = LayoutParams.WRAP_CONTENT;
		layoutParams.height = LayoutParams.WRAP_CONTENT;
		layoutParams.topMargin = OfCampusApplication.dp(35);
		layoutParams.leftMargin = OfCampusApplication.dp(71);
		layoutParams.rightMargin = OfCampusApplication.dp(16);
		layoutParams.gravity = Gravity.LEFT;
		...
		layoutParams.width = OfCampusApplication.dp(40);
		layoutParams.height = OfCampusApplication.dp(40);
		layoutParams.leftMargin = OfCampusApplication.dp(16);
		layoutParams.rightMargin = OfCampusApplication.dp(0);
		...
		layoutParams.width = OfCampusApplication.dp(22);
		layoutParams.height = OfCampusApplication.dp(22);
		layoutParams.topMargin = OfCampusApplication.dp(34);
		layoutParams.leftMargin = OfCampusApplication.dp(38);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(OfCampusApplication.dp(64), MeasureSpec.EXACTLY));
	}
