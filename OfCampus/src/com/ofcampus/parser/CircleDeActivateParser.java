...
public class CircleDeActivateParser {
	...
	private class CircleDeActivateParserAsync extends AsyncTask<Void, Void, Void> {
		...
		public CircleDeActivateParserAsync(Context mContext, JSONObject postData_, String authorization_) {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				String[] responsedata = Util.POSTWithJSONAuth(Util.getCircleDeActivateUrl(), postData, authorization);
	...
	public void setCircleDeActivateparserinterface(CircleDeActivateParserInterface CircleDeActivateparserinterface) {
