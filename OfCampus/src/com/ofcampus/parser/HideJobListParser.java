...
public class HideJobListParser {
	...
	public void parse(Context context, JSONObject postData, String authorization) {
		...
		HideJobListParserAsync mHideJobListParser = new HideJobListParserAsync(mContext, postData, authorization);
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			mHideJobListParser.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
		} else {
			mHideJobListParser.execute();
		}
	}

	private class HideJobListParserAsync extends AsyncTask<Void, Void, Void> {
		...
		public HideJobListParserAsync(Context mContext, JSONObject postData_, String authorization_) {
		...
		protected void onPostExecute(Void result) {
			...
			if (isTimeOut) {
				if (hidejoblistparserinterface != null) {
					hidejoblistparserinterface.OnError();
				}
...
//				Util.ShowToast(mContext, responseDetails);
	...
	public HideJobListParserInterface hidejoblistparserinterface;

	public HideJobListParserInterface getHidejoblistparserinterface() {
		return hidejoblistparserinterface;
	}

	public void setHidejoblistparserinterface(HideJobListParserInterface hidejoblistparserinterface) {
		this.hidejoblistparserinterface = hidejoblistparserinterface;
	}

	public interface HideJobListParserInterface {
