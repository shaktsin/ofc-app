...
public class RegistrationParser {
	...
	public static List<NameValuePair> getparamBody(String firstName, String lastName, String accountName, String email, String password, String instituteId, String gender, String verified,
			String thirdPartAuth) {
	...
	public JSONObject getjsonBody(String firstName, String lastName, String accountName, String email, String password, String instituteId, String gender, String verified, String thirdPartAuth,
			userType user) {
