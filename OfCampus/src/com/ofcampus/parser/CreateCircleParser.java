...
public class CreateCircleParser {
	...
	private class CreateCircleParserAsync extends AsyncTask<Void, Void, Void> {
		...
		public CreateCircleParserAsync(Context mContext, JSONObject postData_, String authorization_) {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				String[] responsedata = Util.POSTWithJSONAuth(Util.getCreateCircleUrl(), postData, authorization);
...
//				Util.ShowToast(mContext, responseDetails);
	...
	public void setCreatecircleparserinterface(CreateCircleParserInterface createcircleparserinterface) {
