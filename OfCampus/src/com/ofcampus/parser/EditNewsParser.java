	...
	private class Async extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				String[] responsedata = Util.POSTWithAuthJSONFile(Util.getEditNewsUrl(), obj_, auth, paths, "feed", docpdfPaths);
...
//				Util.ShowToast(mContext, responseDetails);
	...
	public void setEditnewsparserinterface(EditNewsParserInterface editnewsparserinterface) {
