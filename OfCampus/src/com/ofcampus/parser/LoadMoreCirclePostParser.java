...
public class LoadMoreCirclePostParser {
	...
	private class Async extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				String[] responsedata = Util.POSTWithJSONAuth(Util.getCirclePosts(), postData, authorization);
		...
		protected void onPostExecute(Void result) {
			...
			if (isTimeOut) {
				...
				if (posts != null) {
					if (loadMoreCirclePostParserInterface != null) {
						loadMoreCirclePostParserInterface.OnSuccess(posts);
					}
				} else {
					loadMoreCirclePostParserInterface.NoData();
				}
	...
	private void error() {
		if (loadMoreCirclePostParserInterface != null) {
			loadMoreCirclePostParserInterface.OnError();
		}
	}
	...
	public LoadMoreCirclePostParserInterface loadMoreCirclePostParserInterface;

	public LoadMoreCirclePostParserInterface getLoadMoreCirclePostParserInterface() {
		return loadMoreCirclePostParserInterface;
	}

	public void setLoadMoreCirclePostParserInterface(LoadMoreCirclePostParserInterface loadMoreCirclePostParserInterface) {
		this.loadMoreCirclePostParserInterface = loadMoreCirclePostParserInterface;
	}

	public interface LoadMoreCirclePostParserInterface {
