...
public class AcceptRequestToJoinCircleParser {
	...
	private class AcceptRequestParserAsync extends AsyncTask<Void, Void, Void> {
		...
		public AcceptRequestParserAsync(Context mContext, JSONObject postData_, String authorization_) {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				String[] responsedata = Util.POSTWithJSONAuth(Util.getAcceptRequestUrl(), postData, authorization);
	...
	public void setAcceptrequestparserinterface(AcceptRequestParserInterface acceptrequestparserinterface) {
