...
public abstract class CustomView extends RelativeLayout {
	...
	protected void setAttributes(AttributeSet attrs) {
		setMinimumHeight(ProgressBarDeterminateUtility.dpToPx(minHeight, getResources()));
		setMinimumWidth(ProgressBarDeterminateUtility.dpToPx(minWidth, getResources()));
