...
public class PagerSlidingTabStripForCircle extends HorizontalScrollView {
	...
	// @formatter:off
	private static final int[] ATTRS = new int[] { android.R.color.white, R.color.color_background };
	// @formatter:on
	...
	public PagerSlidingTabStripForCircle(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStripForCircle(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PagerSlidingTabStripForCircle(Context context, AttributeSet attrs, int defStyle) {
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrollStateChanged(int state) {
			if (state == ViewPager.SCROLL_STATE_IDLE) {
				highlightText(pager.getCurrentItem());
